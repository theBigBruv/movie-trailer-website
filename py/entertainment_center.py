...
the_departed = media.Movie("The Departed", "2006", "R",
                           ...
                           "../images/the_departed.jpg",
                           "https://www.youtube.com/watch?v=SGWvwjZ0eDc")
crash = media.Movie("Crash", "2004", "R",
                    ("Los Angeles citizens with vastly separate "
                     "lives collide in interweaving stories of "
                     "race, loss and redemption."),
                    "Paul Haggis",
...
iron_man = media.Movie("Iron Man", "2008", "PG-13",
                       ("After being held captive in an Afghan cave, an "
                        "industrialist creates a unique weaponized suit "
...
the_avengers = media.Movie("The Avengers", "2012", "PG-13",
                           ...
                           "../images/the_avengers.jpg",
                           "https://www.youtube.com/watch?v=eOrNdBpGMv8")
robocop = media.Movie("RoboCop", "2014", "PG-13",
                      ("In 2028 Detroit, when Alex Murphy - a loving "
                       "husband, father and good cop - is critically "
                       "injured in the line of duty, the multinational "
                       "conglomerate OmniCorp sees their chance for a "
...
three_hundred = media.Movie("300", "2006", "R",
                            ("King Leonidas and a force of 300 men fight "
                             "the Persians at Thermopylae in 480 B.C."),
                            "Zack Snyder",
                            "Gerard Butler, Lena Headey, David Wenham",
                            "../images/three_hundred.jpg",
                            "https://www.youtube.com/watch?v=UrIbxk7idYA")

# Add the 12 movie instances created into a list
movies = ([avatar, the_departed, crash, titanic,
           the_matrix, safe_house, iron_man, the_avengers,
           robocop, inception, gladiator, three_hundred])

# Call the open_movies_page function contained in the fresh_tomatoes
# module, passing in the movies list as input
